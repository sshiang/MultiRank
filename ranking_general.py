...
parser.add_argument('-i', '--input-dir', dest='relationDir', default="/Users/eternal0815/research/train_2015_10_18/relation_terrain_general/relations.txt", help='Directory of relation input.')
parser.add_argument('-p', '--predict-dir', dest='predictDir', default="/Users/eternal0815/research/dataset/train_2016_09_21a/predict_fold1/", help='Directory of predict input.')
parser.add_argument('-o', '--output-dir', dest='outputDir', default='rerank_terrain/', help='Output directory.')
parser.add_argument('-l', '--label', dest='labelPath', default="/Users/eternal0815/research/train_2015_10_18/labelList", help='label mapping file')
	...
	for i in range(len(layers)):
		for j in range(len(layers)):
			...
			if opts.dimension == 2:
				...
				# near
				if abs(ix1-jx2)<=670*0.1 or abs(ix2-jx2)<=670*0.1:
					if abs(iy1-jy2)<=384*0.1 or abs(iy2-jy1)<=384*0.1:
...
relationMap = readRelation("%s"%(opts.relationDir), opts.number)
...
for alpha in alphas:
	...
	for imagename in os.listdir(opts.predictDir):#opts.relationDir):
		print imagename
